...
const Registration = () => {
    ...
    const handleRegi = async (e) => {
        ...
        const res = await api.post('/api/registration', user);
            ...
            <div>
                <div className='flex justify-center mx-auto'>
                    <div className='w-[400px] '><div class="container">
                        ...
                        <form onSubmit={handleRegi} class="form">
                            <input
                                placeholder="E-mail"
                                id="email"
                                name="email"
                            ...
                            <input value="Sign In" type="submit" class="login-button text-white text-xl" /><div class="social-account-container">
